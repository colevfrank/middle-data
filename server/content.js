...
const DATA_TYPES = [
  ...
  { id: 13, inline: 'photos library', plural: false,
    ...
    category: 'Expressive' },
  { id: 14, inline: 'email management behavior', plural: false,
    ...
    category: 'Process' },
  { id: 15, inline: 'administrative task behavior', plural: false,
    ...
    category: 'Process' },
  { id: 16, inline: 'cooking behavior', plural: false,
  ...
  { id: 18, inline: 'streaming preferences', plural: true,
    ...
    category: 'Behavioral/Preference' },
  { id: 19, inline: 'screen usage', plural: false,
    ...
    category: 'Behavioral/Preference' },
  { id: 20, inline: 'exercise activities', plural: true,
